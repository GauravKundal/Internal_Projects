...
export default function Users({ auth }) {
  ...
  async function del(id) {
    ...
    try {
      await api.delete(`/users/delete/${id}`, "DELETE", null, auth.token);
      setUsers((prev) => prev.filter((u) => u.user_id !== id));
    } catch (e) {
      if(e.response.data.code=='BOOKING_ALREADY_EXISTS'){
        toast.error("User already has booking so we cannot delete this user",{ transition: Bounce });
      }
      else{
